...
if (exist('time_perf_eiquadprog.m', 'file'))
    source time_perf_eiquadprog.m
    figure
    title('eiquadprog')
    hold on
    plot(eiquadprog_simulation.no_hotstart.average_time_to_run_full_loop, 'b')
    hold off
end

if (exist('time_perf_quadprogpp.m', 'file'))
    source time_perf_quadprogpp.m
    figure
    title('quadprogpp')
    hold on
