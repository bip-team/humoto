    ...
    namespace wpg04
    {
                ...
                public TestBase
        {
            protected:
                ...
                {
                    reference_.solution_.readConfig(g_ref_filename, true, "Solution_FixedFootPositions");
                    reference_.state_.readConfig(g_ref_filename, true, "ModelState_FixedFootPositions");
                ...
                public TestBase
        {
            protected:
                ...
                {
                    reference_.solution_.readConfig(g_ref_filename, true, "Solution_RotatingFeet");
                    reference_.state_.readConfig(g_ref_filename, true, "ModelState_RotatingFeet");
                ...
                public TestBase
        {
            protected:
                ...
                {
                    reference_.solution_.readConfig(g_ref_filename, true, "Solution_HRP4Parameters");
                    reference_.state_.readConfig(g_ref_filename, true, "ModelState_HRP4Parameters");

                    walk_parameters.readConfig (g_config_path + "walk_parameters__walk_in_place_7_steps.yaml");
                    robot_parameters.readConfig(g_config_path + "robot_hrp4.yaml");
                    model_state.readConfig     (g_config_path + "initial_state_hrp4.yaml");
                ...
                public TestBase
        {
            protected:
                ...
                {
                    reference_.solution_.readConfig(g_ref_filename, true, "Solution_SingleConfigurationFile");
                    reference_.state_.readConfig(g_ref_filename, true, "ModelState_SingleConfigurationFile");

                    humoto::config::Reader config_reader("regression_test_001.yaml");
