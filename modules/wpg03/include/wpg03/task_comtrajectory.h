...
namespace humoto
{
    ...
    {
        /**
         * @brief Trajectory tracking control on the Center of Mass
         *        position, velocity and acceleration at each time instant
         */
        class TaskCoMTrajectory: public humoto::TaskAB
        {
            public:
                TaskCoMTrajectory(const double gain = 0.707106781186548) 
                    : TaskAB("TaskCoMTrajectory", gain)
                {
                }
                            ...
                            const humoto::ControlProblem &control_problem)
                {
                    ...
                    b = getGain() * (mpc.Gmbk_ *(mpc.Cref_ - mpc.s_));
                    //TODO: combine with impedance task, make sure signs are ok
                };
        };
    }
}
